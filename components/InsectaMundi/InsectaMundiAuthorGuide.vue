    ...
    <div class="flex justify-between gap-x-4 my-6">
      ...
      <div class="flex flex-col gap-4 w-full sm:max-w-[60%] lg:max-w-[70%] mt-3">
        <p>
          ...
          but also openly accessible. This can only be done with authors submitting manuscripts publishable 
          by journal standards, not just in quality, but also in technical details. The length of time needed to 
          publish any manuscript is inversely proportional to the amount of time, effort, and attention to details the 
          author and reviewers spend prior to submission. Authors who understand how to build and clean manuscripts with 
          word processing and photo editing programs will have no difficulty following our requirements and publishing in 
          Insecta Mundi.
        </p>
        <p class="text-justify mt-4">
          If you wish to publish in <b>Insecta Mundi</b>, 
          we have various guides available to help you through manuscript preparation processes. 
      ...
      <div class="flex flex-col gap-4 w-full sm:max-w-[30%] lg:max-w-[35%] mt-3">
