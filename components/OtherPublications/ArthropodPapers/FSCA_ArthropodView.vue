...
const copied = ref(false)        // true when something is copied
const copiedMessage = ref('')    // message to show in tooltip
...
function copyToClipboard(text, label = 'Copied!') {
  ...
  copied.value = true
  setTimeout(() => (copied.value = false), 1500) // hide after 1.5s
}
...
<div class="md:w-1/2 flex items-center justify-center">
  ...
  <div class="flex flex-col">
    <span class="text-xs font-semibold text-gray-600 uppercase mb-1">DOI</span>
<div class="relative flex items-center">
  ...
  <!-- Zoobank -->
  <div class="flex flex-col">
    <span class="text-xs font-semibold text-gray-600 uppercase mb-1">Zoobank</span>
...
<div class="flex gap-4 justify-center">
  ...
  <a v-if="paper.pdfhigh" :href="paper.pdfhigh" target="_blank"
     class="px-6 py-3 text-base  bg-setenary/80 border border-setenary text-white rounded-lg hover:bg-secondary transition">
    High-res PDF
  </a>
</div>
