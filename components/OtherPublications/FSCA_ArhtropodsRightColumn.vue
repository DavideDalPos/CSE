...
<template>
    <div class="w-full lg:w-[300px] shrink-0 bg-white p-4 border-l-2 border-quaternary/80">
    <!-- Section Title -->
    <div class="mb-4">
        <h2 class="text-xl text-center font-semibold text-setenary dark:text-gray-200">Explore Our Publications</h2>
