<template>
  <div class="my-10">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 font-serif">
      <div
...
<div class="flex items-center justify-between mb-2">
  ...
  <div>
    <p class="text-lg font-bold text-senary leading-tight tracking-wide text-shadow-sm">
      {{ meeting.year }}
    </p>
    <h3 class="font-semibold text-primary hover:text-yellow-700 transition-colors text-shadow-sm leading-snug">
      {{ meeting.title }}
    </h3>
  </div>
  ...
  >
    NEW
        ...
        <div class="flex items-center mb-4">
          ...
          <div class="border-l border-gray-300 h-6 mx-2"></div> <!-- Divider -->
          <div class="flex items-center text-sm text-gray-700">
            <p class="italic">Organizer: <span class="font-bold text-primary">{{ meeting.organizer }}</span></p>
          </div>
        </div>
        ...
        <div class="flex justify-between w-full mt-4">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <a :href="meeting.pdfLink" target="_blank">Download Program</a>
            </div>
<div
  :class="{
...
>
  <svg
    ...
    :class="{
      'text-gray-500': !meeting.secondPdfLink,  /* Gray out the icon */
  ...
  <a :href="meeting.secondPdfLink" target="_blank">Download Extended Program</a>
</div>
...
>
  ...
  <a :href="meeting.video" target="_blank">Watch Full Conference</a>
</div>
...
>
  ...
  <a :href="meeting.image" target="_blank">Download Images</a>
</div>
