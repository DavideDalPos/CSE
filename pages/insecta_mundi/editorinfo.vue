<template>
  <div>
    ...
    <section
      class="bg-gradient-to-br from-gray-100 to-primary/30 border-b border-t border-primary"
    >
...
import InsectaMundiEditorImage from '~/components/InsectaMundi/InsectaMundiEditorImage.vue'
