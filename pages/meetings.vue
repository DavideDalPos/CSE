<template>
  <div>    
    ...
    <section class="bg-gradient-to-br from-gray-100 to-quaternary/30 border-t border-b border-yellow-600">
    <Archive />
  </section>  
  <section class="bg-gradient-to-br from-gray-100 to-foreground">
    <ArchivePoster />
  </section>
